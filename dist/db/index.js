    ...
    switch (config.db.type) {
        ...
        case "oracle": {
            ...
            if (!oc || !oc.user || !oc.password || !oc.connectString || !oc.walletDir) {
                throw new Error("ORACLE_USER, ORACLE_PASSWORD, ORACLE_CONNECT_STRING, and ORACLE_WALLET_DIR are all required for Oracle");
            }
        ...
        default:
            throw new Error(`Unsupported DB_TYPE "${config.db.type}". Supported: postgres, oracle`);
    }
}
